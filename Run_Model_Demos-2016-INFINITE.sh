...
printf "\n\nWavenet for Poem Generation.\nInitializing.\nPlease wait.\n\nPreparing to make 30 poems of $samples letters each.\n\nEach poem is generated from a mathematical model of what poetry is.\n\nThe models were generated using a neural-net (Wavenet) \nin November 2016 in Hong Kong.\n\nThe poems are generated now in realtime.\n\n"
...
do
    ...
    printf "\n\n************************\n\nLOOPING THRU DEMOS AGAIN\n\nWavenet for Poem Generation.\n\nPreparing to make another 30 poems of $samples letters each.\n\n************************\n\n"
